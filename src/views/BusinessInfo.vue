...
<template>
  <div class="w-full h-full">
    ...
    <div class="flex justify-center items-center w-full h-28 flex-col">
      <p class="flex text-3xl font-semibold mt-2">
    ...
    <ul class="w-full mb-7">
      <li v-for="(item,key) in foodArr" :key="item.foodId" class="w-full box-border mx-3 my-8 p-1.25/1 select-none flex justify-between items-center">
        <div class="flex items-center box-content">
          <img class="ml-1 w-1/3 h-1/3" :src="item.foodImg">
...
<!--          <i class="fa fa-shopping-cart fa-3x"></i>-->
          <span class="iconfont">
             <el-icon style="font-size: 15vw"><ShoppingCart /></el-icon>
          </span>
      ...
      <div class="basis-1/3 mr-0">
        ...
        <div v-else class="w- h-full bg-green-500 text-white text-2xl font-bold select-none cursor-pointer flex justify-center items-center" @click="toOrder">
          去结算
        </div>
